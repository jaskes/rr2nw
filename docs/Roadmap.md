...
unrecovered Destroyable behavior remain distinct campaign boundaries rather
than being conflated with Route capacity. Level.07N is proved to author an
empty ProjectTable and no RecruitCenter.
