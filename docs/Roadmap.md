...
| M4 save/timing/VFS | 80% | versioned 17-owner LCN1, atomic same/cross-Level load, CTJ1, RNG split, deterministic VFS/content identity, RPH1 content-bound per-tick Vehicle/CLK1/RNG hashes with dense/sparse presentation observation | production fixed-step/catch-up, complete-world replay hashes, legacy import breadth and long-session timing proof |
