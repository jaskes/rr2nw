...
The first three maintained Windows audio slices are complete. Exact flags-0
...
left/right/outer-silence recovery. This is not byte-exact RSX or full sound
parity: streamed dialogue/music, FLIC/UI, direct Vehicle pitch, asymmetric
...
implementation is approximately **85%** of the Windows-first 1.0 scope; strict
release readiness is approximately **71-75%** because a full campaign and the
...
| M2 Windows platform/stability | 81% | native window/input, focus neutralization, frame profiling, DPI-aware exclusive display ownership/recovery, exact SEH minidump/manifest diagnostics and maintained XAudio2 2.9 cached one-shot, authored Farter loop lifetime plus symmetric listener/moving-Tank compatibility | flags-1 streaming, direct Vehicle pitch, broader moving-class/asymmetric/UI/cinematic audio, prolonged multi-monitor/Win10/Win11 presentation soak, legacy fatal/assert consolidation and sanitizer coverage |
...
3. widen the closed listener/moving-Tank audio model to direct Vehicle pitch,
