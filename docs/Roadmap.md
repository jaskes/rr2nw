...
6. **in progress:** polish profile creation/rename/localized compatibility UX,
   package the validator/examples and run the final
...
| M5 modding | 82% | discovery, dependencies/conflicts, deterministic mount order, validator, data/script overlays, bounded player profiles and restart-only in-frame selector | profile creation/rename polish, broader examples/localization and packaged compatibility UX |
