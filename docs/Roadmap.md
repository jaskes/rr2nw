...
The first four maintained Windows audio slices are complete. Exact flags-0
...
stable no-steal loop registrations, focus/device-loss recovery and schema-5
Effects/Player-Vehicle volumes. Startup verification keeps the device closed and materializes
...
streamed dialogue/music, FLIC/UI, AI engine audio, asymmetric
...
| M2 Windows platform/stability | 83% | native window/input, focus neutralization, frame profiling, DPI-aware exclusive display ownership/recovery, exact SEH minidump/manifest diagnostics and maintained XAudio2 2.9 cached one-shot, authored Farter loop lifetime, symmetric listener/moving-Tank compatibility and direct occupied-Player-Vehicle pitch/lifecycle | flags-1 streaming, broader moving-class/asymmetric/UI/cinematic audio, prolonged multi-monitor/Win10/Win11 presentation soak, legacy fatal/assert consolidation and sanitizer coverage |
| M2.5 in-game shell/settings | 99% | sole ordinary in-frame shell, typed eight-slot Save/Load/restart with asynchronous thumbnails and explicit compatibility states, 26 contextual bindings, retail-bounded mouse X/Y/invert, windowed/borderless/exclusive 4:3 presentation with timed rollback, atomic schema-5 settings/schema-1/2/3/4 migration/safe mode, owned Effects and Player Vehicle volumes, full fail-closed typed Developer catalog and explicitly isolated native diagnostic fallback | packaged multi-monitor Win10/Win11 acceptance |
...
3. widen the closed listener/moving-Tank/Player-Vehicle audio model to
   broader moving classes and flags-1 stream owners;
