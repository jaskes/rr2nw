...
result/save/fresh-load gate and a 3/3 three-process Actek progression gate.
The latter persists `ProjectG0 -> ProjectS04`, completes S04's eight real kill
objectives, persists exact successor `ProjectS07` and contains the retail
duplicate `a.unit.ms04.ap00` without editing `MS04.SC`. The isolated
