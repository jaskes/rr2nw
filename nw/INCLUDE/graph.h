...
typedef struct {
   ...
   unsigned long long ignoredNonPerspectiveBumpPolygons;
   unsigned long long approximatedLightPolygons;
   unsigned long long ditheredBumpPolygons;
   unsigned long long lightThroughPolygons;
   unsigned long long litPolygons;
   unsigned long long litPixels;
   unsigned long long framebufferHash;
   unsigned long long framebufferNonClearPixels;
