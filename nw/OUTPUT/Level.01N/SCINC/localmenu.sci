 ...
 var int vehicleID, vehicleCP;
{
 ...
 s_AddMenuText("/Options/Cheats", "Points", -1, -1, 0, 5, 100, pColor, 128, afColor, 128, abColor, 128, "Font.p_menu.fnt", "Font.a_menu.fnt", "POINTS", "ТОЧКИ");
  ...
  s_AddMenuText("/Options/Cheats/Points", "Point1", vehicleID, vehicleCP, s_Menu_Point1, 5, 60, pColor, 128, afColor, 128, abColor, 128, "Font.p_menu.fnt", "Font.a_menu.fnt", "Recruit Center, Natives", "Вербовочный Пункт Аборигенов");
  s_AddMenuText("/Options/Cheats/Points", "Point2", vehicleID, vehicleCP, s_Menu_Point2, 5, 60, pColor, 128, afColor, 128, abColor, 128, "Font.p_menu.fnt", "Font.a_menu.fnt", "Recruit Center, Conquerors 1", "Вербовочный Пункт Завоевателей 1");
  s_AddMenuText("/Options/Cheats/Points", "Point3", vehicleID, vehicleCP, s_Menu_Point3, 5, 60, pColor, 128, afColor, 128, abColor, 128, "Font.p_menu.fnt", "Font.a_menu.fnt", "Recruit Center, Conquerors 2", "Вербовочный Пункт Завоевателей 2");
  //s_AddMenuText("/Options/Cheats/Points", "Point4", vehicleID, vehicleCP, s_Menu_Point4, 5, 60, pColor, 128, afColor, 128, abColor, 128, "Font.p_menu.fnt", "Font.a_menu.fnt", "Latest Mission Point", "Задание");
