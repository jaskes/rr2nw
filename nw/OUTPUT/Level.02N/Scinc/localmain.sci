...
var int oID0, cachePos0, oID1, cachePos1;
{
   ...
   // s_NewObject( classTableID, "Magician" );
    ...
    s_New( classTableID, "Kingdom" , oID0, cachePos0 );
    s_New( classTableID, "Magician", oID1, cachePos1 );

    s_SetHostileCommander(oID0, cachePos0, oID1, cachePos1);

    //s_AddClassTable( "TankGroup",60 );
    //s_AddClassTable("Tank", 120);
...
{
    s_SetLevel(2); // set of animation for 4-th level
    suavik_Main();
}
